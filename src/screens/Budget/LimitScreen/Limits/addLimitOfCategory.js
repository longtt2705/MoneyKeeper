      ...
      <View>
        <View style={styles.bg}>
          ...
          <View style={styles.itemContainer}>
            <View>
              <View style={styles.item}>
                <Image source={icons.categories} style={styles.iconCate} />
                <Text style={styles.textChooseCate}>Choose Category:</Text>
              </View>
              <View style={styles.chooseCate}>
                <Image source={cate.icon} style={styles.iconCate} />
                <Text style={styles.nameCatechoose}>{cate.title}</Text>
                <TouchableOpacity
                  style={styles.more}
                  onPress={() => {
                ...
                >
                  <Image style={styles.moreicon} source={icons.rightArrow} />
                </TouchableOpacity>
              </View>
            </View>
          ...
          <View style={styles.itemContainer}>
            <View style={styles.item}>
              <Image source={icons.calendar1} style={styles.icon} />
              <View>
