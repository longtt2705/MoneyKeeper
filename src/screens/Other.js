...
export default function Other({ navigation }) {
  return (
    ...
    ___________________________________________________________
        ...
        <View style = {styles.feedback} >
          <TouchableHighlight style={styles.BtnFeedback} onPress = {()=>{
            ...
            <View style = {styles.alignImg}>
            <Image source = { require('../../assets/image/exclamation-mark.png')}
              style = {styles.img}
            />
            <View>
    ...
    ___________________________________________________________
          ...
          <TouchableHighlight style = {styles.BtnChange} onPress={()=>{
            console.log("done");
          }}>
           <View style = {styles.alignImg}>
          ...
          <TouchableHighlight style = {styles.BtnRating} onPress={()=>{
            console.log("done");
          }}>
          <View style = {styles.alignImg}>
          ...
          <View style = {styles.Language}>
            <TouchableHighlight style = {styles.BtnLanguage} onPress={()=>{
             ...
             <View style = {styles.alignImg}>
                <Image source = {require('../../assets/image/translate.png')}
                 style = {styles.img}/>
          ...
          <View style = {styles.Settings}>
            <TouchableHighlight style = {styles.BtnSettings} onPress={()=>{
              console.log("done");
            }}>
             <View style = {styles.alignImg}>
